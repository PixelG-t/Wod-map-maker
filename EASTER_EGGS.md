# 🥚 Easter Egg Guide - WoD Map Maker v2.5

**21 Hidden Easter Eggs** are waiting to be discovered! Can you find them all?

Your progress is tracked in the top-right corner of the editor screen.
...
- (1337, anything) or (anything, 1337)
- (13, 37)
- (133, 7)
...
1. **Track Your Progress**: Look in the top-right corner of the editor
2. **Status Bar is Your Friend**: It shows coordinates, zoom level, and brush size
3. **Be Patient**: Some eggs require precise timing or positioning
4. **Combine Techniques**: Some eggs work well together
5. **Experiment**: Try unusual combinations and patterns
6. **Have Fun!**: These are meant to make map-making more enjoyable
...
| Effect | Triggered By | Duration |
|--------|-------------|----------|
| Party Mode (Confetti) | Konami Code | 15 seconds |
| Disco Mode (Rainbow) | Corner clicks | 10 seconds |
| Matrix Mode (Code Rain) | Center click | Until disabled |
| Inverted Colors | (666,666) | 8 seconds |
| Screen Shake | Zoom spam | 5 seconds |
| Sparkles | Tool cycling | 10 seconds |
| Rainbow Brush | Terrain sequence | Permanent (session) |

---

**Good luck finding all 21 Easter eggs!** 🎉

Remember: The joy is in the discovery. Don't rush - enjoy the journey!

---

*Easter eggs are meant to reward exploration and make the creative process more fun. They don't affect your saved maps - only the editing experience!*
